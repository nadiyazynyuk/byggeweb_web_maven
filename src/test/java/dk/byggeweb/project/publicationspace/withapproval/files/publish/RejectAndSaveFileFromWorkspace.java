...
public class RejectAndSaveFileFromWorkspace extends ProjectTestBase {

    @Link(url = "https://itwofm.atlassian.net/browse/TSB-65")
    ...
    @Test(dependsOnMethods = "publishFileFromWorkspace", description = "Reject and save file")
