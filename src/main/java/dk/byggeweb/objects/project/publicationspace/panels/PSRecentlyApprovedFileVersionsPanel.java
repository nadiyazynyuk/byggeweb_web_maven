...
public class PSRecentlyApprovedFileVersionsPanel extends PublicationSpaceContentPanel {
    ...
    public PSRecentlyApprovedFileVersionsPanel() { panelTitle.shouldBe(visible); }
