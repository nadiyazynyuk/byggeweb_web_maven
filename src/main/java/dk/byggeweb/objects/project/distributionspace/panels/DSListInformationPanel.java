...
public class DSListInformationPanel extends DistributionSpaceContentPanel {
    ...
    private final SelenideElement panelTitle = $(byXpath("//div[contains(@id, 'mp-distribution-info') and contains(@class, 'x-title-text x-title-text-default x-title-item')]"));
