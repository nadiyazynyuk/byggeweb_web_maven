...
public class LoginPage {
    ...
    private SelenideElement usernameInput = $(byXpath("//input[@id='user']"));
    private SelenideElement passwordInput = $(byXpath("//input[@id='xxx']"));
    private SelenideElement loginButton = $(byXpath("//input[@id='submit']"));
